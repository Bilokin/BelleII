void DalitzMC(string filename = "mc.root")
{
	...
	c1->Divide(3,1);
	string E0 = "B0_daughter__bo0__cmE__bc";
	string E1 = "B0_daughter__bo1__cmE__bc";
	string E2 = "B0_daughter__bo2__cmE__bc";
	string px0 = "B0_daughter__bo0__cmpx__bc";
	string px1 = "B0_daughter__bo1__cmpx__bc";
	string px2 = "B0_daughter__bo2__cmpx__bc";
	string py0 = "B0_daughter__bo0__cmpy__bc";
	string py1 = "B0_daughter__bo1__cmpy__bc";
	string py2 = "B0_daughter__bo2__cmpy__bc";
	string pz0 = "B0_daughter__bo0__cmpz__bc";
	string pz1 = "B0_daughter__bo1__cmpz__bc";
	string pz2 = "B0_daughter__bo2__cmpz__bc";
	string p = "+";
	string m = "-";
	string s = "*";
