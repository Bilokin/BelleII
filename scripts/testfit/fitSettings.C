...
struct fitSettings {
	...
	vector<float> DTsmall;
	vector<float> DTsPar;
	vector<float> DTcont;
	vector<float> DTcontPar;
...
fitSettings getStdSettings()
{
	...
	settings.dtbkg2 = {5.2371e-01,2.7222e-01,1.5836,6.2997e-01,4.9696,1.4829};
	settings.mbcbkg2 = {5.2793,4.6633e-03,-6.6620e+01,1.3604e+02,7.2682e+02};
	settings.csbkg2 = {4.8948e-01,4.6557e-01,1.2732,4.0000e+01};
	settings.debkg2 = {6.8044e-03,1.0017e-01};
	...
	settings.DTsmall = {9.9868e+00,8.2149e+00,4.4857e-02,1.0227e-02,5.2230e-02,6.8535e-02};
	settings.DTsPar = {1.7931e+00,3.5468e-08,4.0935e-03,2.9343e-05};
	
	settings.DTcont = {9.8462e-02,1.4601e-03,3.8971e-02,5.7541e+00};
	settings.DTcontPar = {9.3551e-01,9.9738e-02,6.0354e-01,1.3361e-03};
