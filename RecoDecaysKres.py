...
#toolsB0_meson += ['FlightInfo', '^B0 -> ['+Kres+' -> pi+ ^pi- [ K_S0 ->  pi+ pi- ] ] gamma']
#toolsB0_meson += ['MCFlightInfo', '^B0 -> ['+Kres+' -> pi+ pi- [ ^K_S0 ->  pi+ pi- ] ] gamma']
#toolsB0_meson += ['CustomFloats[FTmy:FDmy:FTEmy:FDEmy:MCFDmy:MCFTmy]', '^B0']
