...
string getCuts(bool enableVeto = true, string Kres = "Xsd")
{
	...
	//cut += " && B0_"+Kres+"_pi1_nPXDHits + B0_"+Kres+"_pi1_nSVDHits > 0";
	//cut += " && B0_"+Kres+"_K_S0_pi0_nPXDHits + B0_"+Kres+"_K_S0_pi0_nSVDHits > 0";
	//cut += " && B0_"+Kres+"_K_S0_pi1_nPXDHits + B0_"+Kres+"_K_S0_pi1_nSVDHits > 0";
	//cut += " && "+cosflight+" > 0.995";
	cut += " && iCand == 0 ";
	return cut;
}
