...
{
   fFisher0 = -1.02183851837;
   fFisherCoefficients.push_back( -0.667269034605 );
   fFisherCoefficients.push_back( -0.0552227350938 );
   fFisherCoefficients.push_back( -0.39255680076 );
   fFisherCoefficients.push_back( -1.44981986741 );
   fFisherCoefficients.push_back( -0.49888812668 );
   fFisherCoefficients.push_back( -1.06583424876 );
   fFisherCoefficients.push_back( -0.0396473720312 );
   fFisherCoefficients.push_back( -0.290073838244 );
   fFisherCoefficients.push_back( 0.325701327661 );
   fFisherCoefficients.push_back( 2.39072898854 );
