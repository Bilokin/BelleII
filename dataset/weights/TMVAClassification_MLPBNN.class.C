...
inline void ReadMLPBNN::Initialize()
{
   ...
   fWeightMatrix0to1[0][0] = -1.40922051639239;
   fWeightMatrix0to1[1][0] = 0.128458225874446;
   fWeightMatrix0to1[2][0] = 0.0610442324625422;
   fWeightMatrix0to1[3][0] = -0.983342286926709;
   fWeightMatrix0to1[4][0] = 1.16266647595013;
   fWeightMatrix0to1[5][0] = -2.2919892008821;
   fWeightMatrix0to1[6][0] = -0.527271199900571;
   fWeightMatrix0to1[7][0] = 0.242877731169356;
   fWeightMatrix0to1[8][0] = -0.474497997800808;
   fWeightMatrix0to1[0][1] = -0.73765409936524;
   fWeightMatrix0to1[1][1] = -0.0481305632351767;
   fWeightMatrix0to1[2][1] = -0.0349351367919671;
   fWeightMatrix0to1[3][1] = 0.0436101461728682;
   fWeightMatrix0to1[4][1] = -0.943589630247706;
   fWeightMatrix0to1[5][1] = 0.0878659186937728;
   fWeightMatrix0to1[6][1] = 0.0360454640285985;
   fWeightMatrix0to1[7][1] = 0.0409955917851326;
   fWeightMatrix0to1[8][1] = 0.0543001252890545;
   fWeightMatrix0to1[0][2] = -0.0383037835412182;
   fWeightMatrix0to1[1][2] = 0.0364662295664198;
   fWeightMatrix0to1[2][2] = 0.0190219207218807;
   fWeightMatrix0to1[3][2] = -0.236262364753694;
   fWeightMatrix0to1[4][2] = -0.139152542947488;
   fWeightMatrix0to1[5][2] = -0.329476061228832;
   fWeightMatrix0to1[6][2] = -0.123933385152538;
   fWeightMatrix0to1[7][2] = 0.0781268071925014;
   fWeightMatrix0to1[8][2] = -0.118488568702799;
   fWeightMatrix0to1[0][3] = -0.86334322355238;
   fWeightMatrix0to1[1][3] = -0.283940847072425;
   fWeightMatrix0to1[2][3] = -0.151517820740765;
   fWeightMatrix0to1[3][3] = 1.11007103355057;
   fWeightMatrix0to1[4][3] = 0.0272209600485835;
   fWeightMatrix0to1[5][3] = 1.12666128953213;
   fWeightMatrix0to1[6][3] = 0.778934056107014;
   fWeightMatrix0to1[7][3] = -0.490610024337247;
   fWeightMatrix0to1[8][3] = 0.756807208990601;
   fWeightMatrix0to1[0][4] = 0.0327899630183315;
   fWeightMatrix0to1[1][4] = 0.00145644157319893;
   fWeightMatrix0to1[2][4] = 0.000887185334408409;
   fWeightMatrix0to1[3][4] = -0.000196887835857256;
   fWeightMatrix0to1[4][4] = -0.165474843600782;
   fWeightMatrix0to1[5][4] = 0.00853154418720169;
   fWeightMatrix0to1[6][4] = -0.00533805600277283;
   fWeightMatrix0to1[7][4] = 0.00561229959930704;
   fWeightMatrix0to1[8][4] = -0.00615320637343035;
   // weight matrix from layer 1 to 2
   fWeightMatrix1to2[0][0] = -4.99047874693271;
   fWeightMatrix1to2[0][1] = -1.71193821226236;
   fWeightMatrix1to2[0][2] = -0.865099344872659;
   fWeightMatrix1to2[0][3] = 8.3508131575791;
   fWeightMatrix1to2[0][4] = 8.21623116822907;
   fWeightMatrix1to2[0][5] = 9.92670136419168;
   fWeightMatrix1to2[0][6] = 5.00926522276548;
   fWeightMatrix1to2[0][7] = -3.68746448623868;
   fWeightMatrix1to2[0][8] = 4.7867462021542;
   fWeightMatrix1to2[0][9] = -1.89377549009733;
}
