...
{
   fFisher0 = -0.518473381824;
   fFisherCoefficients.push_back( -0.0859179747511 );
   fFisherCoefficients.push_back( -0.0206644785825 );
   fFisherCoefficients.push_back( -0.217284149434 );
   fFisherCoefficients.push_back( -0.597555311382 );
   fFisherCoefficients.push_back( -0.196040113304 );
   fFisherCoefficients.push_back( -0.756787677771 );
   fFisherCoefficients.push_back( -0.00400046316487 );
   fFisherCoefficients.push_back( -0.102628488825 );
   fFisherCoefficients.push_back( 0.131363909316 );
   fFisherCoefficients.push_back( 0.92654763965 );
