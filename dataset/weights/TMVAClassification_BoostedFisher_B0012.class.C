...
{
   fFisher0 = -0.610847844562;
   fFisherCoefficients.push_back( -0.147418375703 );
   fFisherCoefficients.push_back( -0.0246521721447 );
   fFisherCoefficients.push_back( -0.191287326215 );
   fFisherCoefficients.push_back( -0.676342810644 );
   fFisherCoefficients.push_back( -0.224651665893 );
   fFisherCoefficients.push_back( -0.850058522236 );
   fFisherCoefficients.push_back( -0.00272071490721 );
   fFisherCoefficients.push_back( -0.124606365975 );
   fFisherCoefficients.push_back( 0.176196272274 );
   fFisherCoefficients.push_back( 1.09324749751 );
