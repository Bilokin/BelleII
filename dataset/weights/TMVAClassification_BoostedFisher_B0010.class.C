...
{
   fFisher0 = -0.696609414909;
   fFisherCoefficients.push_back( -0.186002038011 );
   fFisherCoefficients.push_back( -0.026590055274 );
   fFisherCoefficients.push_back( -0.193335705235 );
   fFisherCoefficients.push_back( -0.731945267727 );
   fFisherCoefficients.push_back( -0.250697586159 );
   fFisherCoefficients.push_back( -0.908590838142 );
   fFisherCoefficients.push_back( -0.00181955793319 );
   fFisherCoefficients.push_back( -0.142697042421 );
   fFisherCoefficients.push_back( 0.200907642247 );
   fFisherCoefficients.push_back( 1.23822546121 );
