...
{
   fFisher0 = -0.527332592577;
   fFisherCoefficients.push_back( -0.0835134672657 );
   fFisherCoefficients.push_back( -0.0216932776503 );
   fFisherCoefficients.push_back( -0.220760381382 );
   fFisherCoefficients.push_back( -0.60820368554 );
   fFisherCoefficients.push_back( -0.201916538943 );
   fFisherCoefficients.push_back( -0.786930699199 );
   fFisherCoefficients.push_back( -0.00310031649215 );
   fFisherCoefficients.push_back( -0.104191135572 );
   fFisherCoefficients.push_back( 0.129188084974 );
   fFisherCoefficients.push_back( 0.946393061312 );
