...
{
   fFisher0 = -0.452997492736;
   fFisherCoefficients.push_back( -0.0652436430244 );
   fFisherCoefficients.push_back( -0.0192683422567 );
   fFisherCoefficients.push_back( -0.228184602568 );
   fFisherCoefficients.push_back( -0.554758201506 );
   fFisherCoefficients.push_back( -0.184093162927 );
   fFisherCoefficients.push_back( -0.718016447627 );
   fFisherCoefficients.push_back( -0.00472557442301 );
   fFisherCoefficients.push_back( -0.093111956556 );
   fFisherCoefficients.push_back( 0.10804516861 );
   fFisherCoefficients.push_back( 0.832275397683 );
