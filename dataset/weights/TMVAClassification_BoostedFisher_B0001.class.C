...
{
   fFisher0 = -1.06581869289;
   fFisherCoefficients.push_back( -0.758781156102 );
   fFisherCoefficients.push_back( -0.069297186769 );
   fFisherCoefficients.push_back( -0.467839492125 );
   fFisherCoefficients.push_back( -1.71257569897 );
   fFisherCoefficients.push_back( -0.586209260088 );
   fFisherCoefficients.push_back( -1.07240937222 );
   fFisherCoefficients.push_back( -0.0545939178548 );
   fFisherCoefficients.push_back( -0.335405374053 );
   fFisherCoefficients.push_back( 0.292204629866 );
   fFisherCoefficients.push_back( 2.74059896511 );
