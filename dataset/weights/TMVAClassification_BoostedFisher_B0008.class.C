...
{
   fFisher0 = -0.746387279788;
   fFisherCoefficients.push_back( -0.263367792316 );
   fFisherCoefficients.push_back( -0.0292158423536 );
   fFisherCoefficients.push_back( -0.211924084144 );
   fFisherCoefficients.push_back( -0.798272069003 );
   fFisherCoefficients.push_back( -0.283547754219 );
   fFisherCoefficients.push_back( -0.95706084398 );
   fFisherCoefficients.push_back( -0.00427617966612 );
   fFisherCoefficients.push_back( -0.163027720508 );
   fFisherCoefficients.push_back( 0.231348710415 );
   fFisherCoefficients.push_back( 1.38140122635 );
