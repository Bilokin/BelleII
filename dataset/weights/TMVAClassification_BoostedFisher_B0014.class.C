...
{
   fFisher0 = -0.558949079518;
   fFisherCoefficients.push_back( -0.119310219455 );
   fFisherCoefficients.push_back( -0.0227573189359 );
   fFisherCoefficients.push_back( -0.202770635619 );
   fFisherCoefficients.push_back( -0.640168415814 );
   fFisherCoefficients.push_back( -0.209408998542 );
   fFisherCoefficients.push_back( -0.801172878583 );
   fFisherCoefficients.push_back( -0.00359641394661 );
   fFisherCoefficients.push_back( -0.113591525595 );
   fFisherCoefficients.push_back( 0.154291550296 );
   fFisherCoefficients.push_back( 1.00622517936 );
