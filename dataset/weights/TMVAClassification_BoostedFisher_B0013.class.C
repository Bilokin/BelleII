...
{
   fFisher0 = -0.60456080301;
   fFisherCoefficients.push_back( -0.147481066794 );
   fFisherCoefficients.push_back( -0.0231547617704 );
   fFisherCoefficients.push_back( -0.185764792753 );
   fFisherCoefficients.push_back( -0.665462888578 );
   fFisherCoefficients.push_back( -0.216411760816 );
   fFisherCoefficients.push_back( -0.810523095787 );
   fFisherCoefficients.push_back( -0.00323268154967 );
   fFisherCoefficients.push_back( -0.120852310096 );
   fFisherCoefficients.push_back( 0.178071787989 );
   fFisherCoefficients.push_back( 1.07078879486 );
