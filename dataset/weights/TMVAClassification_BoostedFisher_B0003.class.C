...
{
   fFisher0 = -0.951359577866;
   fFisherCoefficients.push_back( -0.626563222768 );
   fFisherCoefficients.push_back( -0.0483915414925 );
   fFisherCoefficients.push_back( -0.326469540075 );
   fFisherCoefficients.push_back( -1.27966594197 );
   fFisherCoefficients.push_back( -0.440114518142 );
   fFisherCoefficients.push_back( -1.04170584485 );
   fFisherCoefficients.push_back( -0.0317900997308 );
   fFisherCoefficients.push_back( -0.261515439542 );
   fFisherCoefficients.push_back( 0.344708453884 );
   fFisherCoefficients.push_back( 2.13337694212 );
