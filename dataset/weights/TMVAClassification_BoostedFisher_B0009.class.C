...
{
   fFisher0 = -0.709025014717;
   fFisherCoefficients.push_back( -0.258024582682 );
   fFisherCoefficients.push_back( -0.0275033514793 );
   fFisherCoefficients.push_back( -0.182460273688 );
   fFisherCoefficients.push_back( -0.766106588822 );
   fFisherCoefficients.push_back( -0.264346270789 );
   fFisherCoefficients.push_back( -0.907053435392 );
   fFisherCoefficients.push_back( -0.00460551068854 );
   fFisherCoefficients.push_back( -0.154215149505 );
   fFisherCoefficients.push_back( 0.229713119893 );
   fFisherCoefficients.push_back( 1.3054342829 );
