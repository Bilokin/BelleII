...
{
   fFisher0 = -0.902878484297;
   fFisherCoefficients.push_back( -0.466769241485 );
   fFisherCoefficients.push_back( -0.0432682954201 );
   fFisherCoefficients.push_back( -0.31238136064 );
   fFisherCoefficients.push_back( -1.1302193498 );
   fFisherCoefficients.push_back( -0.398542944478 );
   fFisherCoefficients.push_back( -1.07481683765 );
   fFisherCoefficients.push_back( -0.0222981227088 );
   fFisherCoefficients.push_back( -0.236747388407 );
   fFisherCoefficients.push_back( 0.293720477832 );
   fFisherCoefficients.push_back( 1.91131743303 );
