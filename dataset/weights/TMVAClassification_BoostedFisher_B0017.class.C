...
{
   fFisher0 = -0.461565956406;
   fFisherCoefficients.push_back( -0.0627212313839 );
   fFisherCoefficients.push_back( -0.020204781818 );
   fFisherCoefficients.push_back( -0.231514999054 );
   fFisherCoefficients.push_back( -0.564590170008 );
   fFisherCoefficients.push_back( -0.189632318526 );
   fFisherCoefficients.push_back( -0.746636150163 );
   fFisherCoefficients.push_back( -0.00384802690467 );
   fFisherCoefficients.push_back( -0.0944935547756 );
   fFisherCoefficients.push_back( 0.106230473599 );
   fFisherCoefficients.push_back( 0.850422551989 );
