...
{
   fFisher0 = -0.86460819558;
   fFisherCoefficients.push_back( -0.449359174894 );
   fFisherCoefficients.push_back( -0.039096202148 );
   fFisherCoefficients.push_back( -0.262661970232 );
   fFisherCoefficients.push_back( -1.05304459528 );
   fFisherCoefficients.push_back( -0.366999498726 );
   fFisherCoefficients.push_back( -1.02627503124 );
   fFisherCoefficients.push_back( -0.020857923883 );
   fFisherCoefficients.push_back( -0.217917204004 );
   fFisherCoefficients.push_back( 0.294236536592 );
   fFisherCoefficients.push_back( 1.78402320078 );
