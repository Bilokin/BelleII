...
{
   fFisher0 = -0.86226535894;
   fFisherCoefficients.push_back( -0.326568066513 );
   fFisherCoefficients.push_back( -0.0369300502103 );
   fFisherCoefficients.push_back( -0.269565631316 );
   fFisherCoefficients.push_back( -0.973856386507 );
   fFisherCoefficients.push_back( -0.338095209731 );
   fFisherCoefficients.push_back( -1.04433596741 );
   fFisherCoefficients.push_back( -0.0117727992429 );
   fFisherCoefficients.push_back( -0.199807833352 );
   fFisherCoefficients.push_back( 0.253781632205 );
   fFisherCoefficients.push_back( 1.67072695598 );
