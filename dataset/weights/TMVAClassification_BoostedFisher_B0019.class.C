...
{
   fFisher0 = -0.450886975739;
   fFisherCoefficients.push_back( -0.0661664684956 );
   fFisherCoefficients.push_back( -0.0188858663082 );
   fFisherCoefficients.push_back( -0.223466783728 );
   fFisherCoefficients.push_back( -0.547622574182 );
   fFisherCoefficients.push_back( -0.182658231132 );
   fFisherCoefficients.push_back( -0.701136715194 );
   fFisherCoefficients.push_back( -0.00480917251734 );
   fFisherCoefficients.push_back( -0.0927250926367 );
   fFisherCoefficients.push_back( 0.110828168916 );
   fFisherCoefficients.push_back( 0.822780014143 );
