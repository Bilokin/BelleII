...
{
   fFisher0 = -0.830399843007;
   fFisherCoefficients.push_back( -0.316887627518 );
   fFisherCoefficients.push_back( -0.0343195283775 );
   fFisherCoefficients.push_back( -0.233995485303 );
   fFisherCoefficients.push_back( -0.923983943043 );
   fFisherCoefficients.push_back( -0.315987927641 );
   fFisherCoefficients.push_back( -0.992198137772 );
   fFisherCoefficients.push_back( -0.011399914768 );
   fFisherCoefficients.push_back( -0.186616688077 );
   fFisherCoefficients.push_back( 0.251202692886 );
   fFisherCoefficients.push_back( 1.5826490373 );
