...
{
   fFisher0 = -0.645851804548;
   fFisherCoefficients.push_back( -0.149995014626 );
   fFisherCoefficients.push_back( -0.0260460959881 );
   fFisherCoefficients.push_back( -0.217641230281 );
   fFisherCoefficients.push_back( -0.704058329903 );
   fFisherCoefficients.push_back( -0.241277522151 );
   fFisherCoefficients.push_back( -0.896766401129 );
   fFisherCoefficients.push_back( -0.00221334144535 );
   fFisherCoefficients.push_back( -0.132160588966 );
   fFisherCoefficients.push_back( 0.178235837627 );
   fFisherCoefficients.push_back( 1.15883264669 );
