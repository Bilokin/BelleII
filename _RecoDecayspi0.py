...
vertexRave('B0:signal',0.01, 'B0 -> [K_10 -> ^pi+ ^pi- pi0 ^K_S0] gamma')
...
toolsB0_meson =  ['Kinematics','^B0 -> [^K_10 -> ^pi+ ^pi- ^pi0 ^K_S0] ^gamma']
...
toolsB0_meson += ['MCTruth','^B0 -> [^K_10 -> ^pi+ ^pi-  ^pi0 ^K_S0] ^gamma']
toolsB0_meson += ['MCHierarchy','^B0 -> [K_10 -> ^pi+ ^pi-  ^pi0 ^K_S0] gamma']
toolsB0_meson += ['Vertex','^B0 -> [K_10 -> pi+ pi-  ^pi0 ^K_S0] gamma']
toolsB0_meson += ['CustomFloats[significanceOfDistance]', '^B0 -> [K_10 -> pi+ pi-  ^pi0 ^K_S0] gamma']
toolsB0_meson += ['MCVertex','^B0 -> [K_10 -> pi+ pi-  ^pi0 ^K_S0] gamma']
#toolsB0_meson += ['PDGCode','^B0']
toolsB0_meson += ['InvMass','^B0 -> [^K_10 -> pi+ pi-  ^pi0 ^K_S0]  gamma']
...
toolsB0_meson += ['CustomFloats[d0:z0:cosTheta:isSignal]', 'B0 -> [K_10 -> ^pi+ ^pi-  ^pi0 ^K_S0] ^gamma']
toolsB0_meson += ['CustomFloats[useCMSFrame(daughterAngleInBetween(0,1)):cosHelicityAngle]', 'B0 -> [^K_10 -> pi+ pi-  pi0 K_S0] gamma']
toolsB0_meson += ['Dalitz', '^B0 -> [K_10 -> ^pi+ ^pi-  pi0 ^K_S0] gamma']
toolsB0_meson += ['TrackHits','B0 -> [K_10 -> ^pi+ ^pi-  pi0 K_S0] gamma']
...
ntupleTree('pi0', 'pi0:looseFit', Pi0Info)
